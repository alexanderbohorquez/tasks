...
const addTask = () => {
    ...
    // Verificar si ya hay 5 tareas
    if (task.length >= 5) {
        alert("No puedes agregar más de 5 tareas.");
        return; // Salir de la función si ya hay 5 tareas
    }
...
const updateStacks = () => {
    ...
    const progress = (completeTasks / totalTasks) * 100 || 0; // Evitar NaN si totalTasks es 0
    ...
    task.forEach((task, index) => {
        ...
        <div class="taskItem">
            <div class="task ${task.completed ? "completed" : ""}">
                ...
                <img src="IMG/Done.png" alt="Checked" class="check-image" style="display: none;" />
                <p>${task.text}</p>
            </div>
            <div class="icons">
